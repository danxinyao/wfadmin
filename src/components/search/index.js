                    ...
                    switch (item.type) {
                        ...
                        case 'input':
                            return <el-col span={col}>
                                <el-form-item label={item.label}>
                                    <el-input size={'small'} placeholder={typeof item.placeholder === 'undefined' ? '请输入' + item.label : item.placeholder} value={this.util.getValByKey(form, item.model)} on-input={(val) => {this.util.setValByKey(form,item.model,val)}}></el-input>
                                </el-form-item>
                            </el-col>
                        ...
                        case 'inputRange':
                            return <el-col span={col}>
                                <el-form-item label={item.label}>
                                    <el-col span={11}>
                                        <el-input size={'small'} placeholder={typeof item.startPlaceholder === 'undefined' ? '请输入' + item.label + '开始段' : item.startPlaceholder} value={this.util.getValByKey(form, item.start)} on-input={(val) => { this.util.setValByKey(form,item.start,val)}}></el-input>
                                    </el-col>
                                    <el-col span={2}>
                                        <label class="input-link">~</label>
                                    </el-col>
                                    <el-col span={11}>
                                        <el-input size={'small'} placeholder={typeof item.endPlaceholder === 'undefined' ? '请输入' + item.label + '结束段' : item.endPlaceholder} value={this.util.getValByKey(form, item.end)} on-input={(val) => { this.util.setValByKey(form,item.end,val)}}></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        ...
                        case 'select':
                            return <el-col span={col}>
                                <el-form-item label={item.label}>
                                    <el-select size={'small'} clearable={!item.multiple} filterable={true} multiple={item.multiple}
                                               remote={typeof item.remote === 'undefined' ? false: item.remote}
                                               remote-method={typeof item.remoteMethod === 'undefined'?null : (val) => item.remoteMethod(val)}
                                               loading={this.localLoading == 'remoteData'}
                                               placeholder={typeof item.placeholder === 'undefined' ? '请选择' + item.label : item.placeholder} value={this.util.getValByKey(form, item.model)} on-input={(val) => { this.util.setValByKey(form,item.model,val)}}>
                                        {
                                            (() => {
                    ...
                    <el-row class="search">
                        <el-col span={24}>
                            <el-col span={18}>
                                {
                                    // 默认展开选项
                                    formRender(this.form,this.defaultForm, 8)
                                }
