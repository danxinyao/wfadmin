<template>
    <div class="source" v-if="qiniuUploadToken != ''">
        <div>
            <ul class="el-upload-list el-upload-list--picture-card" v-if="isImgFile">
            ...
            <ul class="el-upload-list el-upload-list--text" v-if="!isImgFile">
                <li class="el-upload-list__item is-success" v-for="file in fileList">
                    ...
                    <el-progress :percentage="file.percent" :status=" file.isSuccess ? 'success' : ''"></el-progress>
                </li>
            </ul>
        </div>
    </div>
